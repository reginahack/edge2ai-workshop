...
. Create a new http endpoint: https://hookbin.com
...
Http EndPoint           hookbin endpoint https://
HttpMethod              POST
Disable SSL Validation  No
Enable Request Template No
----
+
...
+
. Click *Execute*
. Back on the https://hookbin.com/ page you will see the submitted messages
+
