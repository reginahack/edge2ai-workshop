...
$ sudo wget https://github.com/zBrainiac/Streaming/releases/download/0.4.0/streaming-0.4.0-jar-with-dependencies.jar -P /opt/cloudera/parcels/FLINK/lib/flink/examples/streaming
$ ./bin/flink run -m yarn-cluster -c flinkConsumer.iotConsumerCount -ynm iotConsumerCount lib/flink/examples/streaming/streaming-0.4.0-jar-with-dependencies.jar
----
+
...
----
$ cd /opt/cloudera/parcels/FLINK
$ ./bin/flink run -m yarn-cluster -c flinkConsumer.iotConsumerFilter -ynm iotConsumerFilter lib/flink/examples/streaming/streaming-0.4.0-jar-with-dependencies.jar
----
+
. Let's see how the application works
+
