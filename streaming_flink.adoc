...
----
$ cd /opt/cloudera/parcels/FLINK
$ ./bin/flink run -m yarn-cluster -c flinkConsumer.iotConsumerFilter -ynm iotConsumerCount lib/flink/examples/streaming/streaming-0.4.0-jar-with-dependencies.jar
----
+
. Let's see how the application works
+
